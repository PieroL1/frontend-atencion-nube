      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <section className="mb-8 sm:mb-12">
          <div className="flex items-center gap-3 mb-4">
            <span className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-medium bg-primary/10 dark:bg-primary/20 text-primary border border-primary/30">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-ink dark:text-slate mb-2">
                ¡Hola, {firstName}! 👋
              </h1>
              <p className="text-base sm:text-lg text-slate dark:text-slate/70">
        ...
        <section>
          <div className="grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
            {items.map((item) => (
              ...
              >
                {/* Gradient header */}
                <div className={`h-24 sm:h-32 bg-gradient-to-br ${item.color} relative overflow-hidden`}>
                ...
                <div className="p-4 sm:p-6">
                  {/* Icono grande */}
                  <div className={`w-14 h-14 sm:w-16 sm:h-16 ${item.iconBg} rounded-2xl flex items-center justify-center -mt-10 sm:-mt-14 mb-3 sm:mb-4 shadow-lg relative z-10 group-hover:scale-110 transition-transform duration-300`}>
                    <span className="text-3xl sm:text-4xl">{item.icon}</span>
                  </div>

                  {/* Título */}
                  <h3 className="text-lg sm:text-xl font-bold text-ink dark:text-slate mb-2 group-hover:text-primary transition-colors">
                    {item.name}
                  </h3>

                  {/* Descripción corta */}
                  <p className="text-xs sm:text-sm text-slate dark:text-slate/70 font-medium mb-2 sm:mb-3">
                    {item.desc}
                  </p>

                  {/* Descripción larga - Oculta en móvil muy pequeño */}
                  <p className="hidden xs:block text-xs text-slate/80 dark:text-slate/60 leading-relaxed line-clamp-3">
                    {item.longDesc}
                  </p>

                  {/* Badge de acción */}
                  <div className="mt-3 sm:mt-4 flex items-center text-primary group-hover:translate-x-2 transition-transform duration-300">
                    <span className="text-xs sm:text-sm font-semibold">Ingresar al módulo</span>
        ...
        {/* Footer informativo */}
        <section className="mt-8 sm:mt-12 grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
          <div className="bg-white dark:bg-night rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-slate/20">
            <div className="flex items-center gap-3 mb-2 sm:mb-3">
              ...
              <h4 className="text-sm sm:text-base font-semibold text-ink dark:text-slate">¿Necesitas ayuda?</h4>
            </div>
            <p className="text-xs sm:text-sm text-slate dark:text-slate/70">
          ...
          <div className="bg-white dark:bg-night rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-slate/20">
            <div className="flex items-center gap-3 mb-2 sm:mb-3">
              ...
              <h4 className="text-sm sm:text-base font-semibold text-ink dark:text-slate">Comunidad activa</h4>
            </div>
            <p className="text-xs sm:text-sm text-slate dark:text-slate/70">
          ...
          <div className="bg-white dark:bg-night rounded-xl p-4 sm:p-6 border border-gray-200 dark:border-slate/20">
            <div className="flex items-center gap-3 mb-2 sm:mb-3">
              ...
              <h4 className="text-sm sm:text-base font-semibold text-ink dark:text-slate">Orientación disponible</h4>
            </div>
            <p className="text-xs sm:text-sm text-slate dark:text-slate/70">
